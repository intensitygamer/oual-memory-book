...
/**
* Template Name: Memory Book Registration Page Template
*
...
<html lang="en">
	<head>
		...
		<title>Start a memory book project by signing up | Once Upon A Legacy</title>
	</head>
	<body class="memory_book_body sign-up">
				...
				<div class="row">
					...
					<div class="col-6">
						...
						<form class="oual_form_front" method="post">
							<input type="hidden" name="form_check" value="oual_registration">

							<div class="mb-3">
								<label for="user_email" class="col-form-label-lg">Email Address</label>
								<input type="email" class="form-control form-control-lg" id="user_email" name="user_email" placeholder="johndoe@onceuponalegacy.com" required>
							</div>
							<div class="mb-5">
								<label for="user_password" class="col-form-label-lg">Password</label>
								<input type="password" id="user_password" name="user_password" autocomplete="user_password" class="form-control form-control-lg mb-2" spellcheck="false" autocorrect="off" autocapitalize="none" required="" placeholder="••••••••">
								
								<div class="row">
									<div class="col-8">
										<div id="password_help" class="form-text">At least 8 characters minimum.</div>
									</div>
							...
							<div class="row">
								<div class="col-4">
									<div class="d-grid">
										<button class="btn btn-primary btn-lg submit_registration" type="submit">Sign up</button>
									</div>
								</div>
							</div>
